...
<html>
	...
	<body>
	<center>
			<h1>Gopi krishna welcome to DJANGO HTML webpage</h1>
			<hr color="brown" width="95%"/>
			<h2>Gopi krishna welcome to DJANGO HTML webpage</h2>
			<hr color="brown" width="85%"/>
			<h3>Gopi krishna welcome to DJANGO HTML webpage</h3>
			<hr color="brown" width="75%"/>
			<h4>Gopi krishna welcome to DJANGO HTML webpage</h4>
			<hr color="brown" width="65%"/>
			<h5>Gopi krishna welcome to DJANGO HTML webpage</h5>
			<hr color="brown" width="55%"/>
			<h6>Gopi krishna welcome to DJANGO HTML webpage</h6>
...
def demo(request):     
    ...
    htmldata='''
    <center>
		<h1>Welcome Gopikrishna User!!!</h1>
		<hr />
